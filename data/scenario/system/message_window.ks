;メッセージレイヤの定義
		...
		[position width=600 height=316 top=0 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=0 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=600 height=316 top=0 left=20 ]
